    ...
    <div className='relative h-screen flex justify-center w-screen'>
      <div className='flex flex-col max-w-full justify-center items-center '>
        <div className='w-3/6 tracking-wide flex pb-[9vh] flex-col items-center'>
            ...
            <h1 className='text-4xl pb-4 font-bold text-black'>My Services</h1>
            <p className='font-medium text-center opacity-50'>Lorem ipsum dolor sit, amet Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias non corrupti esse totam quas quidem eius impedit! Officiis, adipisci vel! consectetur adipisicing elit. Voluptate, vero? Lorem ipsum dolor sit amet.</p>
        </div>
     <div className="container mx-auto py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 p-4">
        {/* Service Box 1 */}
        <div className="flex flex-col items-center bg-white p-6 -mb-16 rounded-lg shadow-lg hover:shadow-2xl hover:bg-[#1C4ED8] hover:text-white transition duration-300">
          <div className="w-16 h-16 mx-auto mb-4 mt-4">
          <svg width="35" height="33" viewBox="0 0 35 33" className='m-5'>
          ...
          <p className="opacity-50 text-center">Description of service 1 goes here. Briefly explain what this service offers.</p>
        </div>

        {/* Service Box 2 */}
        <div className="flex flex-col items-center bg-white p-6 -mb-16 rounded-lg shadow-lg hover:shadow-2xl hover:bg-[#1C4ED8] hover:text-white transition duration-300">
          <div className="w-16 h-16 mx-auto mb-4">
            <svg width="36" height="36" viewBox="0 0 36 36" className='m-5'>
        ...
        {/* Service Box 2 */}
        <div className="flex flex-col items-center bg-white p-6 -mb-16 rounded-lg shadow-lg hover:shadow-2xl hover:bg-[#1C4ED8] hover:text-white transition duration-300">
          <div className="w-16 h-16 pt-3 mx-auto mb-4">
          <svg width="40" height="25" viewBox="0 0 40 25" className='m-4'>
          ...
          <p className="opacity-50 text-center">Description of service 2 goes here. Briefly explain what this service offers.</p>
        </div>

        {/* Service Box 3 */}
        <div className="flex flex-col items-center bg-white p-6 -mb-16 rounded-lg shadow-lg hover:shadow-2xl hover:bg-[#1C4ED8] hover:text-white transition duration-300">
          <div className="w-16 h-16 mx-auto mb-4">
            <svg width="30" height="30" viewBox="0 0 30 30" className='m-5'>
          ...
          <p className="opacity-50 text-center">Description of service 3 goes here. Briefly explain what this service offers.</p>
        </div>
      </div>
    </div>
      </div>
