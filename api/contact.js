...
${message}`,
    ...
    return res.status(500).json({ error: err?.message || "Failed to send owner email" });
  }
...
— Hemant Satwal`,
    ...
    return res.status(200).json({ ok: true, note: "Owner mail sent; auto-reply failed", details: err?.message });
  }
